...
NETWORK_IFACE=vboxnet0
# for tor
IFACE_IP="0.0.0.0"
# DB password
PASSWD="solarwinds123"
...
function install_osslsigncode(){
    sudo apt-get update && sudo apt-get -y install build-essential autoconf libtool libssl-dev python3-pkgconfig libcurl4-gnutls-dev
    cd /tmp || return
